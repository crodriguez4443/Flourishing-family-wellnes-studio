...
rightText: Preparing to conceive, moving through pregnancy, or simply carrying more stress than sleep can undo. It pairs beautifully with chiropractic and nutrition inside a program.
highlightsEyebrow: What it helps with
highlightsTitle: Quiet support, real difference.
planTitle: Acupuncture leads the fertility work.
details:
  - Fertility and preconception support
  - Pregnancy comfort and birth preparation support
  - A calm care experience with realistic expectations
highlights:
  - title: Hormonal support
    text: Supporting balance across the cycle and the preconception window.
  - title: Fertility & preconception
    text: Preparing the body in the months before trying or transfer.
